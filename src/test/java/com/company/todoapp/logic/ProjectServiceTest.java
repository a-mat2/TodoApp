...
import com.company.todoapp.model.*;
...
class ProjectServiceTest {
    ...
    @Test
    @DisplayName("should throw IllegalArgumentException when configured allow just 1 group and no groups and projects for given id")
