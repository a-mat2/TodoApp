...
import com.company.todoapp.logic.TaskGroupService;
...
class TaskGroupController {
    ...
    public TaskGroupController(@Lazy TaskRepository sqlTaskRepository, TaskGroupService service) {
    ...
    String addGroupStep(@ModelAttribute("group") GroupWriteModel current) {
        current.getTasks().add(new GroupTaskWriteModel());
        return "groups";
    }

    @PostMapping(params = "deleteTask", produces = MediaType.TEXT_HTML_VALUE)
    String deleteGroupStep(@ModelAttribute("group") GroupWriteModel current) {
